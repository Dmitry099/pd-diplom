"""
Django settings for netology_pd project.
...
SECRET_KEY = 'mqkda14*2jea!_mrifuy1(cqsyo&ji01l(kpfb-0%^u()(p+iy'
...
WSGI_APPLICATION = 'netology_pd.wsgi.application'
...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': 'profession_diplom',
        'USER': 'proffesion_diplom_user',
        'PASSWORD': '12345678',
        'HOST': '127.0.0.1',
        'PORT': '5432',
    }
